...
public class BookFlight extends JFrame implements ActionListener{
    ...
    JTextField tfaadhar;
    JLabel tfname, tfnationality, tfaddress, labelgender, labelfname, labelfcode, labeltdate;
    JButton bookflight, flight, fetchUserButton;
    ...
    public BookFlight(){
        ...
        lbltdate.setBounds(60, 530, 150, 25);
        lbltdate.setFont(new Font("Tahoma", Font.PLAIN, 16));
        add(lbltdate);
        
        labeltdate = new JLabel();
        labeltdate.setBounds(220, 530, 150, 25);
        add(labeltdate);
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("airlinemanagementsystem2/icons/details.jpg"));
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            ...
            if (rs.next()){
                ...
                JOptionPane.showMessageDialog(null, "Please enter correct ssdhar card");
            }
        ...
        } else
        {
                ...
                String sour = source.getSelectedItem();
            ...
            String query = "insert into reservation values('PNR-"+random.nextInt(1000000)+"', 'TIC-"+random.nextInt(1000000)+"', '"+aadhar+"', '"+name+"', '"+nationality+"', '"+flightname+"', '"+flightcode+"', '"+sour+"', '"+des+"', '"+ddate+"')";
